...
import {
	...
	Texture,
	// constants
	NearestFilter, LinearFilter, NearestMipMapNearestFilter, LinearMipMapNearestFilter,
	NearestMipMapLinearFilter, LinearMipMapLinearFilter, ClampToEdgeWrapping,
	MirroredRepeatWrapping, RepeatWrapping, BackSide, FrontSide, NeverDepth,
	LessDepth, EqualDepth, LessEqualDepth, GreaterEqualDepth, NotEqualDepth,
	AlwaysDepth, AddEquation, SubtractEquation, ReverseSubtractEquation, ZeroFactor,
	OneFactor, SrcColorFactor, OneMinusSrcColorFactor, SrcAlphaFactor, 
	OneMinusSrcAlphaFactor, DstAlphaFactor, OneMinusDstAlphaFactor, DstColorFactor,
	OneMinusDstColorFactor, SrcAlphaSaturateFactor, InterpolateLinear,
	InterpolateDiscrete, RGBAFormat, RGBFormat, VertexColors, DoubleSide, sRGBEncoding,
...
var GLTFLoader = ( function () {
  ...
  GLTFBinaryExtension
	...
	function GLTFMaterialsPbrSpecularGlossinessExtension() {
		...
		return {
			...
			createMaterial: function ( params ) {
				...
				material.lightMap = params.aoMap === undefined ? null : params.aoMap;
    ...
    if ( material.lightMap && geometry.attributes.uv2 === undefined && geometry.attributes.uv !== undefined ) {
			// console.log( 'GLTFLoader: Duplicating UVs to support lightMap.' );
			geometry.setAttribute( 'uv2', new BufferAttribute( geometry.attributes.uv.array, 2 ) );
    ...
    var materialDef = json.materials[ materialIndex ];
		...
		if ( materialDef.occlusionTexture !== undefined && materialType !== MeshBasicMaterial ) {
			...
			pending.push( parser.assignTexture( materialParams, 'lightMap'/*aoMap */, materialDef.occlusionTexture ) );

			if ( materialDef.occlusionTexture.strength !== undefined ) {

				materialParams.lightMapIntensity/*aoMapIntensity*/ = materialDef.occlusionTexture.strength;
